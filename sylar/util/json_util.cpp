...
// 在 JSON 字符串中，像 "（双引号）、\（反斜杠）、换行符 \n 等字符是特殊符号，
// 必须用反斜杠 \ 来转义，否则 JSON 无法正确解析。例如：
// {
//     "msg": "this is a "bad" string"  // 错误的 JSON，双引号没被转义
// }
// {
//     "msg": "this is a \"bad\" string"  //转移后才是合法的
// }
